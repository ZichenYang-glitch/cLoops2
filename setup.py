...
setup(
    ...
    setup_requires=["joblib", "numpy", "seaborn", "pandas", "scipy","scikit-learn","matplotlib","tqdm","pyBigWig","networkx", "statsmodels"],
    install_requires=["joblib", "numpy", "seaborn", "pandas", "scipy","scikit-learn","matplotlib","tqdm","pyBigWig","networkx", "statsmodels"],
    entry_points={
        'console_scripts': [
